...
public class GridLayoutTest extends JFrame{
    ...
    private void init() {
        ...
        // 第四个面板
        panels[3].setBackground(new Color(13,45,27));
        for (int i = 0; i < 10; i++){
            panels[3].add(new JButton("button"));
        }
        //第五个面板
        panels[4].setLayout(new GridLayout(3,3,10,10));
        panels[4].setBackground(new Color(62,201,120));
        for (int i = 2; i<17; i++){
